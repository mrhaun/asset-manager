...
<form onSubmit={e => {
  ...
  <div class="hero-content flex-col lg:flex-row-reverse">
    <div class="text-center lg:text-left">
      <h1 class="text-5xl font-bold">Register new account</h1>
      <p class="py-6">Provident cupiditate voluptatem et in ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
    </div>
